...
//Made changes to people, elements, and settlers. I wanted to see what changes It will make on the website. The changes I added were famous chemist, different elements, and locations
people = ['ROBERT BOYLE', 'JOSEPH PRIESTLEY', 'ANTOINE LAVOISIER', 'JOHN DALTON', 'HUMPHRY DAVY', 'MICHAEL FARADAY', 'LOUIS PASTEUR', 'ALFRED NOBEL'],
elements = ['LITHIUM', 'NITROGEN', 'TITANIUM', 'ZINC', 'COPPER', 'IRON', 'SILVER', 'TIN', 'PLATINUM', 'GOLD', 'LEAD', 'MERCURY', 'URANIUM'],
settlers = ['NEW YORK', 'ATLANTA', 'PENNSYLVANIA', 'MASSACHUSETTS', 'CALIFORNIA', 'TEXAS', 'FLORIDA', 'WASHINGTON', 'OREGON', 'ARIZONA'];

//change maximum to 2.
function rand_range(maximum) {
    "use strict";
    return Math.floor(Math.random() * (maximum + 2)); //change maximum to 2.
}

function choose(array) {
    "use strict";
    return array[rand_range(array.length - 2)]; //change array.length to - 2.
}
function stanza() {
    "use strict";
    return 'THE CHEMIST  ' + choose(people) + '<br \>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; WHO STUDIED ' + choose(elements) + '<br \>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IN ' + choose(settlers);
}
function litany() {
    "use strict";
